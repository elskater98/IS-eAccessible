...
public class ServiceServiceLocator extends org.apache.axis.client.Service implements service2.ServiceService {
    ...
    private java.lang.String ServicePort_address = "http://localhost:8080/eAccessibleBackEndWeb/Service";
    ...
    public service2.Service getServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            service2.ServiceServiceSoapBindingStub _stub = new service2.ServiceServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (service2.Service.class.isAssignableFrom(serviceEndpointInterface)) {
                service2.ServiceServiceSoapBindingStub _stub = new service2.ServiceServiceSoapBindingStub(new java.net.URL(ServicePort_address), this);
                _stub.setPortName(getServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service2/", "ServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service2/", "ServicePort"));
        }
